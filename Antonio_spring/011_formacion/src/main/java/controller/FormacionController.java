...
public class FormacionController {
	...
	public @ResponseBody Alumno buscarAlumno(@RequestParam("usuario") String usuario)  {		
		return formacionService.buscarAlumno(usuario);
	}
	...
	public @ResponseBody Curso buscarCurso(@RequestParam("usuario") int curso)  {		
		return formacionService.buscarCurso(curso);
	}
